...
layout = [[sg.Text('      Smart Crop Recommendation And Soil Feedback System   ', font=("Helvetica", 30), text_color = 'Purple')],                                                                                                   
         [sg.Text('Please enter the following details :-', font=("Helvetica", 20))],                                                                                          
         [sg.Text('Ratio of Nitrogen in the soil                                  :', font=("Helvetica", 20)), sg.Input(font=("Helvetica",20), size = (20,1) )],
         [sg.Text('Ratio of Phosphorous in the soil                           :', font=("Helvetica", 20)), sg.Input(font=("Helvetica", 20),size = (20,1))],
         [sg.Text('Ratio of Potassium in the soil                               :', font=("Helvetica", 20)), sg.Input(font=("Helvetica", 20),size = (20,1))],
         [sg.Text('Average Temperature value around the field         :', font=("Helvetica", 20)), sg.Input(font=("Helvetica", 20),size = (20,1)), sg.Text('*C', font=("Helvetica", 20))], 
         [sg.Text('Average percentage of Humidity around the field   :', font=("Helvetica", 20)), sg.Input(font=("Helvetica", 20),size = (20,1)), sg.Text('%', font=("Helvetica", 20))], 
         [sg.Text('PH value of the soil                                              :', font=("Helvetica", 20)), sg.Input(font=("Helvetica", 20),size = (20,1))], 
         [sg.Text('Average amount of Rainfall around the field          :', font=("Helvetica", 20) ), sg.Input(font=("Helvetica", 20),size = (20,1)),sg.Text('mm', font=("Helvetica", 20))],
         [ sg.Text(size=(50,1),font=("Helvetica",20) , text_color = 'yellow', key='-OUTPUT2-' )],
         [ sg.Text(size=(50,1),font=("Helvetica",20) , text_color = 'yellow', key='-OUTPUT3-' )],
         [[sg.Button('Submit', font=("Helvetica", 20)),sg.Button('Quit', font=("Helvetica", 20))] ,
             sg.Multiline(size=(50,25),font=("Helvetica",20) , text_color = 'black', key='-OUTPUT1-' )],
         
         ]
         
window = sg.Window('Smart Crop Recommendation and Soil Feedback System', layout,size=(1200,800), background_color='green') 
...
while True: 
	...
	window['-OUTPUT1-'].update('The best crop that you can grow : ' + crop_name+'\n' + "The ratio of potassium in the soil is  " + potassium_level +'\n' +"The temperature level around the field is  " + temperature_level +'\n'+ "The humidity level around the field is  " + humidity_level +'\n'+ "The ph type of the soil is  " + phlevel + '\n'+"The amount of rainfall is  " + rainfall_level)                                     
